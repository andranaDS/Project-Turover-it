...
class CompaniesFavoritesTest extends ApiTestCase
{
    ...
    public function testDataWithFilters(): void
    {
        $client = static::createTurnoverAuthenticatedClient();
        $a = $client->request('GET', '/companies/favorites?businessActivity=/company_business_activities/3&size=more_than_1000_employees');
