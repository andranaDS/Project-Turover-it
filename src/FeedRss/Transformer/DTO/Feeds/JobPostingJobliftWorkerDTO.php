...
class JobPostingJobliftWorkerDTO implements JobPostingDTOInterface
{
    /**
    ...
    {
        $this->tag = ['tagName' => 'category', 'tagValue' => RssTransformer::transformForRss($title)];
    }

    public function setExperience(?string $experience): void
    {
        $this->experience = RssTransformer::transformExperienceTranslated($experience);
    }
}
