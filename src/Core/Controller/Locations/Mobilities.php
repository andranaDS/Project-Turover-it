...
{
    /**
     * @Route(name="api_core_locations_mobilities", path="/locations/mobilities", methods={"GET"})
    ...
    public function __invoke(Request $request, LocationManager $lm, NormalizerInterface $normalizer): JsonResponse
    {
        ...
        $normalizedResults = $normalizer->normalize($lm->autocompleteMobilities($search), 'json', ['groups' => 'location']);
