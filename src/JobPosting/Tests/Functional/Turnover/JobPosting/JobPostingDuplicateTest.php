...
class JobPostingDuplicateTest extends ApiTestCase
{
    public function testNotLogged(): void
    {
        $client = static::createTurnoverClient();
        $client->request('POST', '/job_postings/1/duplicate');
    ...
    public function testNotFound(): void
    {
        ...
        $client->request('POST', '/job_postings/101/duplicate');
    ...
    public function testLoggedAsOwner(): void
    {
        ...
        self::assertJsonContains([
            ...
            'slug' => 'responsable-applicatifs-finance-h-f-cdi-1',
