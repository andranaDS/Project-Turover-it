...
class ExecutePublishedCommand extends ContainerAwareCommand
{
    use Parallelization;

    protected static $defaultName = 'app:sync:execute-published';
    ...
    protected function fetchItems(InputInterface $input): array
    {
        ...
        $jobPostings = $entitiesToSyncCount > 0 ? $this->getJobPostingsToSync($jobPostingsSyncDate, $entitiesToSyncCount, true) : [];
