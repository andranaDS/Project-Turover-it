...
class BlogCategoryPostsGetTest extends ApiTestCase
{
    public function testWithExistingCategory(): void
    {
        $client = static::createFreeWorkClient();
        $client->request('GET', '/blog_categories/blog-category-1/posts');

        self::assertResponseIsSuccessful();
        self::assertResponseHeaderSame('content-type', 'application/ld+json; charset=utf-8');
        self::assertJsonContains([
            '@context' => '/contexts/BlogPost',
            '@id' => '/blog_categories/blog-category-1/posts',
            ...
            'hydra:totalItems' => 4,
            'hydra:view' => [
                '@id' => '/blog_categories/blog-category-1/posts?page=1',
                '@type' => 'hydra:PartialCollectionView',
                'hydra:first' => '/blog_categories/blog-category-1/posts?page=1',
                'hydra:last' => '/blog_categories/blog-category-1/posts?page=2',
                'hydra:next' => '/blog_categories/blog-category-1/posts?page=2',
            ],
        ]);
    }
    ...
    {
        $client = static::createFreeWorkClient();
        $client->request('GET', '/blog_categories/blog-category-non-existent/posts');
